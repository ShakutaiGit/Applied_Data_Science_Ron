...
class xgboost:
    ...
    def split_to_train_test(self):
        ...
        model = XGBClassifier(max_depth=mean_best_parameters['max_depth'], n_estimators=mean_best_parameters['n_estimators'],
                              learning_rate=mean_best_parameters['learning_rate'],
                                verbosity = 0,
                                use_label_encoder = False,
                                use_subset = False,
                                verbose=False
